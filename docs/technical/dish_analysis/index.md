...
| # | Page | Description |
|---|------|-------------|
| 1 | [Component Identification](./component_identification.md) | Phase 1 — Component Identification Gemini call, `ComponentIdentification` schema, background task wiring, polling contract |
| 2 | [User Customization](./user_customization.md) | React editor component, local state shape, `POST /confirm-identification` contract, DB optimistic write |
| 3 | [Nutritional Analysis](./nutritional_analysis.md) | Phase 2 — Nutritional Analysis Gemini call, prompt injection of confirmed components, `NutritionalAnalysis` schema |
