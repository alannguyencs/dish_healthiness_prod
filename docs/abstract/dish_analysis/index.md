# Dish Analysis — Abstract

[< Prev: Meal Upload](../meal_upload.md) | [Parent](../index.md)

Dish analysis is a two-phase AI workflow that runs automatically after the user uploads a meal photo. The first phase identifies the dish and its components; the user then corrects those proposals before the second phase calculates nutrition and a healthiness score from the confirmed data.
