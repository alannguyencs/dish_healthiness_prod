...
- **Included:**
  ...
  - Nutritional Analysis Manual Edit — field-by-field correction of healthiness, macros, micronutrients
  - Nutritional Analysis AI Assistant Edit — prompt-driven revision that commits the revised payload directly (no preview step)
- **Not included:**
...
- [x] Nutritional Analysis card exposes both Manual Edit and AI Assistant Edit buttons side-by-side
- [x] AI Assistant Edit accepts a non-empty hint, disables both edit buttons while the revision is in flight, and re-renders the Nutritional Analysis card with revised numbers without a preview step
