...
### Cooking Method and Regional Variant Context

In the analysis, information about the **cooking style, preparation method, and regional variant** is taken into account. When inferring nutrient numbers, explicitly weigh the dish's:

- **Cooking style** — deep-fried vs steamed vs grilled vs raw
- **Preparation method** — battered, breaded, tempered, sauced
- **Regional variant** — e.g. North-Indian vs South-Indian curry, Hainanese vs Hakka chicken rice, Sichuan vs Cantonese
