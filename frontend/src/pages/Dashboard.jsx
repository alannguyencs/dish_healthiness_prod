...
const Dashboard = () => {
  ...
  const loadDashboardData = async () => {
    try {
      setLoading(true);
      const data = await apiService.getDashboardData(currentYear, currentMonth);
    ...
    <div className="min-h-screen bg-gray-100 p-4">
      <div className="max-w-7xl mx-auto bg-white rounded-lg shadow-lg p-6">
        ...
        <MonthNavigation
          ...
          onPrevious={() =>
            navigateToMonth(calendarData.prev_year, calendarData.prev_month)
          }
          onNext={() =>
            navigateToMonth(calendarData.next_year, calendarData.next_month)
          }
        />
