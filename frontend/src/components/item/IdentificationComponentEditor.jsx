...
const IdentificationComponentEditor = ({
  identificationData,
  confirmedData,
  onConfirm,
  isConfirming,
}) => {
  const { dish_predictions = [], components = [] } = identificationData || {};
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
        ...
        {(identificationData.model ||
          identificationData.price_usd ||
          identificationData.analysis_time) && (
          <div className="mt-4 pt-4 border-t border-gray-200">
            <div className="flex items-center gap-6 text-sm text-gray-600">
              ...
              {identificationData.price_usd !== undefined && (
                <div className="flex items-center gap-1.5">
                  <span>💰</span>
                  <span>Cost:</span>
                  <span className="font-medium">
                    ${identificationData.price_usd.toFixed(4)}
                  </span>
                </div>
              )}
              {identificationData.analysis_time !== undefined && (
                <div className="flex items-center gap-1.5">
                  <span>⏱️</span>
                  <span>Time:</span>
                  <span className="font-medium">
                    {identificationData.analysis_time}s
                  </span>
                </div>
              )}
            </div>
...
export default IdentificationComponentEditor;
