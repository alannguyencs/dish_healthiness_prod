 ...
 * the nutrition results card's button row when the user clicks "AI
 * Assistant Edit".
 *
 * Parent (NutritionResults) owns the open/closed state and the hint
 * value so the textarea persists across re-renders while the revise
 * call is in flight. `assisting` disables Submit and the textarea while
 * the backend Gemini call is running.
 */
const NutritionAiAssistantPanel = ({
  value,
  onChange,
  onSubmit,
  onCancel,
  ...
  return (
    <div
      ...
      data-testid="nutrition-ai-assistant-panel"
    >
      ...
      <textarea
        ...
        data-testid="nutrition-ai-assistant-textarea"
      />
      <div className="flex items-center justify-end gap-2">
        <button
          ...
          data-testid="nutrition-ai-assistant-cancel"
        >
          Cancel
        </button>
        <button
          ...
          data-testid="nutrition-ai-assistant-submit"
        >
...
export default NutritionAiAssistantPanel;
